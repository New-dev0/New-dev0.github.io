...
export default function Projects() {
    return <>
        ...
        <Template show_content={false}>
            ...
            <CreateCard title="Template-Generater" description="Create profile templates for Github, Telegram and more." href="https://template.newdev0.in" style={{minWidth: "20rem"}}/>
            ...
            <CreateCard title="Bing-Chatbot" description={"Bing AI Based Telegram Chat bot."} href={gh("Bing-ChatBot")}  style={{minWidth: "20rem"}}/>
        </Template>
    </>
}