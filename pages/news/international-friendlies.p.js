...
export default function Page() {
    ...
    return <><Head>
        <title>International friendlies</title>
        <meta name="keywords" content="news,trending,latest,sports,breaking,top,International friendlies"/>
        <meta name="description" content="Trending News about International friendlies" /></Head><Template>
            <h1 style={{fontSize: "30"}}>International friendlies</h1>
            <Image width={800} height={500} src="https://editorial.uefa.com/resources/027b-169ceb4552a4-e9a4df906300-1000/eq.jpeg" alt="International friendlies"/>
            <h3>Recent News</h3>
