    ...
    return <><Head>
        ...
        <meta name="description" content="Trending News about Zac Efron" /></Head><Template>
            ...
            <div className={styles.card} style={{ maxWidth: "90%", width: md ? "auto": "90vh"}}>
                ...
                <p style={{marginLeft: "15px"}}>Für eine neue Rolle hat sich Zac Efron (35) jetzt einen komplett neuen Look zugelegt. In dem Film „The Iron Claw“ verkörpert er einen Profi-Wrestler.</p></div>
            </div>
        </a>
        </Template></>;
}