...
export default function Page() {
    ...
    return <><Head>
        <title>День ракетных войск и артиллерии</title>
        <meta name="keywords" content="news,trending,latest,sports,breaking,top,День ракетных войск и артиллерии"/>
        <meta name="description" content="Trending News about День ракетных войск и артиллерии" /></Head><Template>
            <h1 style={{fontSize: "30"}}>День ракетных войск и артиллерии</h1>
            <Image width={800} height={500} src="" alt="День ракетных войск и артиллерии"/>
            <h3>Recent News</h3>
            <a href='https://www.sstu.ru/news/19-noyabrya-v-rossii-otmechaetsya-den-raketnykh-voysk-i-artillerii.html'>
            <div className={styles.card} style={{ maxWidth: "90%", width: md ? "auto": "90vh"}}>
                <h3>19 ноября в России отмечается День ракетных войск и ...</h3>
                <div style={{ display: "flex" }}>
                <Image src="https://t0.gstatic.com/images?q=tbn:ANd9GcSYUHP4qsE_BoTtziaqaR3yI_H_REfBJoqzwUDO75B7BqQSYHZXaEge63P9x6PoiJW43EmwmCLeGA" alt="19 ноября в России отмечается День ракетных войск и ..." height={150} width={150} style={{marginLeft: "15px"}}/>
                <p style={{marginLeft: "15px"}}>Этот праздник напоминает о многовековой летописи этого рода войск и героическом подвиге артиллеристов во время Великой Отечественной войны.</p></div>
            </div>
        </a><a href='https://pobedarf.ru/2022/11/19/den-raketnyh-vojsk-i-artillerii/'>
            <div className={styles.card} style={{ maxWidth: "90%", width: md ? "auto": "90vh"}}>
            ...
            <div className={styles.card} style={{ maxWidth: "90%", width: md ? "auto": "90vh"}}>
                <h3>Сегодня в России отмечается День ракетных войск и артиллерии</h3>
                <div style={{ display: "flex" }}>
                <Image src="https://t2.gstatic.com/images?q=tbn:ANd9GcTrUJ5fVZpCSnSdGasaMRVQ7BGTYqX9nU49xg5Smf3D0TRyZ-mT8BIFs_c309iU05zB3fmDkOXA" alt="Сегодня в России отмечается День ракетных войск и артиллерии" height={150} width={150} style={{marginLeft: "15px"}}/>
                <p style={{marginLeft: "15px"}}>Праздник отмечается в ознаменование заслуг артиллерии в разгроме немецко-фашистских захватчиков под Сталинградом.</p></div>
            </div>
        </a><a href='https://rt-online.ru/segodnya-den-raketnyh-vojsk-i-artillerii/'>
            <div className={styles.card} style={{ maxWidth: "90%", width: md ? "auto": "90vh"}}>
                <h3>Сегодня – День ракетных войск и артиллерии</h3>
                <div style={{ display: "flex" }}>
            ...
            <div className={styles.card} style={{ maxWidth: "90%", width: md ? "auto": "90vh"}}>
                <h3>День ракетных войск и артиллерии 2022: поздравления в стихах ...</h3>
                <div style={{ display: "flex" }}>
