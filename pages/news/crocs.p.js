    ...
    return <><Head>
        ...
        <meta name="description" content="Trending News about Crocs" /></Head><Template>
            ...
            <div className={styles.card} style={{ maxWidth: "90%", width: md ? "auto": "90vh"}}>
                ...
                <p style={{marginLeft: "15px"}}>If you&#39;re a creature of comfort, this is the shoe for you. Beloved by chefs, medical workers and kids alike, Crocs are lightweight, easy to clean, quick-drying&nbsp;...</p></div>
            </div>
