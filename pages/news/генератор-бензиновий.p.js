...
export default function Page() {
    ...
    return <><Head>
        <title>Генератор бензиновий</title>
        <meta name="keywords" content="news,trending,latest,sports,breaking,top,Генератор бензиновий"/>
        <meta name="description" content="Trending News about Генератор бензиновий" /></Head><Template>
            <h1 style={{fontSize: "30"}}>Генератор бензиновий</h1>
            <Image width={800} height={500} src="https://vsim.ua/img/cache/reference/news_fb_og/0029/60/2859470-hto-y-za-skilki-pridbav-generatori-u-hmelnitskomu-oglyad-zakladiv-i-pidpriemstv.jpeg" alt="Генератор бензиновий"/>
            <h3>Recent News</h3>
