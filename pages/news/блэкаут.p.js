...
export default function Page() {
    ...
    return <><Head>
        <title>Блэкаут</title>
        <meta name="keywords" content="news,trending,latest,sports,breaking,top,Блэкаут"/>
        <meta name="description" content="Trending News about Блэкаут" /></Head><Template>
            <h1 style={{fontSize: "30"}}>Блэкаут</h1>
            <Image width={800} height={500} src="https://www.rbc.ua/static/img/_/e/_elektroopori_gettyimages_1241194848_16_1300x820.jpg" alt="Блэкаут"/>
            <h3>Recent News</h3>
        ...
        </a><a href='https://vgolos.ua/news/u-dtek-povidomili-chi-zagrozhuie-ukrayini-blekaut_1430163.html'>
            <div className={styles.card} style={{ maxWidth: "90%", width: md ? "auto": "90vh"}}>
                <h3>У ДТЕК повідомили, чи загрожує Україні блекаут</h3>
                <div style={{ display: "flex" }}>
                <Image src="https://t1.gstatic.com/images?q=tbn:ANd9GcSJveAUycctVJb4cq75vAB4hN--LLLZTM4Tk3kc-6dIBM29IG4hlD0NKZwLw2d7lCpjP91_Y2v7" alt="У ДТЕК повідомили, чи загрожує Україні блекаут" height={150} width={150} style={{marginLeft: "15px"}}/>
                <p style={{marginLeft: "15px"}}>Директор ДТЕК Дмитро Сахарук повідомив, що попри велике бажання Росії, аби Україна опинилася у повній темряві, такий сценарій є малоймовірним.</p></div>
            </div>
