...
export default function Page() {
    ...
    return <><Head>
        ...
        <meta name="description" content="Trending News about Preços combustíveis próxima semana" /></Head><Template>
        ...
        </a><a href='https://cnnportugal.iol.pt/combustiveis/gasoleo/preco-dos-combustiveis-volta-a-descer-na-segunda-feira/20221125/63809d530cf2aea7857ea527'>
            <div className={styles.card} style={{ maxWidth: "90%", width: md ? "auto": "90vh"}}>
                <h3>Preço dos combustíveis volta a descer na segunda-feira</h3>
                <div style={{ display: "flex" }}>
                <Image src="https://t2.gstatic.com/images?q=tbn:ANd9GcQ1Ang4B3Ywmhj0GUI13TKK_xUdcTS5YYMYjOe2Ak6gYxfoxslcH9aBBzOfk1AON97IFQsEQL6n" alt="Preço dos combustíveis volta a descer na segunda-feira" height={150} width={150} style={{marginLeft: "15px"}}/>
                <p style={{marginLeft: "15px"}}>A confirmar-se a descida prevista, no espaço de um mês a gasolina já desceu quase 18 cêntimos por litro e o gasóleo quase 30 cêntimos.</p></div>
            </div>
            ...
            <div className={styles.card} style={{ maxWidth: "90%", width: md ? "auto": "90vh"}}>
                ...
                <p style={{marginLeft: "15px"}}>A descida deve-se a vários fatores, entre os quais a queda do brent e o desconto no imposto sobre os produtos petrolíferos. Sem este mecanismo fiscal, os&nbsp;...</p></div>
            </div>
