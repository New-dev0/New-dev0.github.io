...
export default function Page() {
    ...
    return <><Head>
        <title>Netherlands vs Ecuador</title>
        ...
        <meta name="description" content="Trending News about Netherlands vs Ecuador" /></Head><Template>
            ...
            <div className={styles.card} style={{ maxWidth: "90%", width: md ? "auto": "90vh"}}>
                <h3>Netherlands vs Ecuador: Lineups and LIVE updates</h3>
                <div style={{ display: "flex" }}>
                <Image src="https://t1.gstatic.com/images?q=tbn:ANd9GcTyoC8WDlYOYKj4KW4CmiTkdYZXbzXI0C6pqjxEM8tjBXvW2C5g9MI9eJj-qefm9En8j7uJIX-j" alt="Netherlands vs Ecuador: Lineups and LIVE updates" height={150} width={150} style={{marginLeft: "15px"}}/>
                <p style={{marginLeft: "15px"}}>Will the Dutch assert their dominance on Group A, or will Ecuador pull off a major upset?</p></div>
            </div>
        ...
        </a><a href='https://www.livemint.com/news/world/netherlands-vs-ecuador-prediction-fifa-world-cup-2022-football-11669346056653.html'>
            <div className={styles.card} style={{ maxWidth: "90%", width: md ? "auto": "90vh"}}>
                <h3>FIFA World Cup 2022: Netherlands vs Ecuador prediction, time, live ...</h3>
                <div style={{ display: "flex" }}>
                <Image src="https://t1.gstatic.com/images?q=tbn:ANd9GcQ1_lDjve-4y841yTlncYImaZy8i5wr-qaHLygZw5XBc4VAYEl0nnvwABXR8cnFnhF-bNlPDwf8" alt="FIFA World Cup 2022: Netherlands vs Ecuador prediction, time, live ..." height={150} width={150} style={{marginLeft: "15px"}}/>
                <p style={{marginLeft: "15px"}}>FIFA World Cup 2022: A win in the Netherlands vs Ecuador match will decide who will enter the next round from Group A.</p></div>
            </div>
        </a><a href='https://sports.ndtv.com/fifa-world-cup-2022/fifa-world-cup-2022-netherlands-vs-ecuador-football-live-score-updates-3553425'>
            <div className={styles.card} style={{ maxWidth: "90%", width: md ? "auto": "90vh"}}>
                <h3>Netherlands vs Ecuador FIFA World Cup 2022 Highlights: Ecuador ...</h3>
                <div style={{ display: "flex" }}>
            ...
            <div className={styles.card} style={{ maxWidth: "90%", width: md ? "auto": "90vh"}}>
                ...
                <div style={{ display: "flex" }}>
                <Image src="https://t2.gstatic.com/images?q=tbn:ANd9GcTTDOedJ537RS9h6NM7gT7aM7S4HUto-oOP1EsKve708s8DrfWCDqJmgcsxoGg2tzscXYtm1WG2" alt="Netherlands vs Ecuador HIGHLIGHTS: Enner Valencia scores as ..." height={150} width={150} style={{marginLeft: "15px"}}/>
