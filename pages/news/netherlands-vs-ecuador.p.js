    ...
    return <><Head>
        ...
        <meta name="description" content="Trending News about Netherlands vs Ecuador" /></Head><Template>
            ...
            <div className={styles.card} style={{ maxWidth: "90%", width: md ? "auto": "90vh"}}>
                ...
                <p style={{marginLeft: "15px"}}>Both the Netherlands and Ecuador won their opening games with solid performances against Senegal and Qatar respectively. A win for either team could help&nbsp;...</p></div>
            </div>
