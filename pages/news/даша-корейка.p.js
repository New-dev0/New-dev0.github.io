    ...
    return <><Head>
        ...
        <meta name="description" content="Trending News about Даша Корейка" /></Head><Template>
            ...
            <div className={styles.card} style={{ maxWidth: "90%", width: md ? "auto": "90vh"}}>
                ...
                <Image src="https://t3.gstatic.com/images?q=tbn:ANd9GcQE6nGwNFX6c-RYjXlRLRVv0qQ0WIxN3X8wgaCcEk-0lQVTQwR8SMI-U6iPE32KKlNuxDTIM579" alt="Даша Корейка: «Ребята, это мой последний кружок вообще в ..." height={150} width={150} style={{marginLeft: "15px"}}/>
