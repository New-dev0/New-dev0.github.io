...
export default function Page() {
    ...
    return <><Head>
        <title>Англія - Іран</title>
        <meta name="keywords" content="news,trending,latest,sports,breaking,top,Англія - Іран"/>
        <meta name="description" content="Trending News about Англія - Іран" /></Head><Template>
            <h1 style={{fontSize: "30"}}>Англія - Іран</h1>
            <Image width={800} height={500} src="" alt="Англія - Іран"/>
            <h3>Recent News</h3>
            <a href='https://suspilne.media/321676-anglia-rozgromila-iran-na-starti-cempionatu-svitu-2022-z-futbolu/'>
            <div className={styles.card} style={{ maxWidth: "90%", width: md ? "auto": "90vh"}}>
                <h3>Англія розгромила Іран на старті чемпіонату світу-2022 з футболу</h3>
                <div style={{ display: "flex" }}>
                <Image src="https://t1.gstatic.com/images?q=tbn:ANd9GcRpqCbFhm6YA-Rzi0MRkB0Fxjqf4jztnHB2gNurrJdjpIC0xxZoIFfkOU7M5IuPumGp53zbMusn" alt="Англія розгромила Іран на старті чемпіонату світу-2022 з футболу" height={150} width={150} style={{marginLeft: "15px"}}/>
                <p style={{marginLeft: "15px"}}>suspilne.media Збірна Англії з футболу розгромила Іран у драматичному першому матчі групи B на чемпіонаті світу-2022: як минув матч, протести перед грою,&nbsp;...</p></div>
            </div>
        </a><a href='https://espreso.tv/angliya-roztroshchila-iran-u-matchi-chs-2022'>
            <div className={styles.card} style={{ maxWidth: "90%", width: md ? "auto": "90vh"}}>
                <h3>ЧС-2022: Англія розтрощила Іран у матчі з 8 голами</h3>
                <div style={{ display: "flex" }}>
                <Image src="https://t0.gstatic.com/images?q=tbn:ANd9GcSv7qWqk8nWCiSvwDY-b74jgNgmVzyT97QMWmD1HFT7dpinSYAoyCq_jU-l0_t2jrPvzJjAYPhn" alt="ЧС-2022: Англія розтрощила Іран у матчі з 8 голами" height={150} width={150} style={{marginLeft: "15px"}}/>
                <p style={{marginLeft: "15px"}}>21 листопада у 1-му турі чемпіонату світу з футболу збірна Англії перемогла Іран - Читайте все найважливіше про ЧС-2022 на Еспресо.</p></div>
            </div>
        </a><a href='https://www.ua-football.com/ua/foreign/worldcup/1668956239-angliya-iran-de-y-koli-divitis-onlayn-match-chempionatu-svitu.html'>
            <div className={styles.card} style={{ maxWidth: "90%", width: md ? "auto": "90vh"}}>
                <h3>Англія - Іран: де й коли дивитись онлайн матч Чемпіонату світу</h3>
                <div style={{ display: "flex" }}>
