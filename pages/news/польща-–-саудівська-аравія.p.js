...
export default function Page() {
    ...
    return <><Head>
        <title>Польща – Саудівська Аравія</title>
        <meta name="keywords" content="news,trending,latest,sports,breaking,top,Польща – Саудівська Аравія"/>
        <meta name="description" content="Trending News about Польща – Саудівська Аравія" /></Head><Template>
            <h1 style={{fontSize: "30"}}>Польща – Саудівська Аравія</h1>
            <Image width={800} height={500} src="https://img.tsn.ua/cached/056/tsn-90ef87392779da7417a975ee734335dc/thumbs/1200x630/dd/4c/c7b57dd1dfbd4b878d8b2377a3614cdd.jpeg" alt="Польща – Саудівська Аравія"/>
            <h3>Recent News</h3>
            <a href='https://tsn.ua/prosport/pershiy-gol-levandovski-na-chs-polscha-v-matchi-z-nezabitim-penalti-peremogla-saudivsku-araviyu-2210383.html'>
            <div className={styles.card} style={{ maxWidth: "90%", width: md ? "auto": "90vh"}}>
                <h3>Перший гол Левандовські на ЧС: Польща в матчі з незабитим ...</h3>
            ...
            <div className={styles.card} style={{ maxWidth: "90%", width: md ? "auto": "90vh"}}>
                ...
                <div style={{ display: "flex" }}>
                <Image src="https://t3.gstatic.com/images?q=tbn:ANd9GcTNzlURS9DIexLGLS7tIiPWlQSEy1pWfCGVgfxDTbHFGkU0tCHlFRVL_2OQmj9YJv9iIeviSwGP" alt="ЧС-2022: Польща перемогла Саудівську Аравію та захопила ..." height={150} width={150} style={{marginLeft: "15px"}}/>
                <p style={{marginLeft: "15px"}}>26 листопада у 2-му турі чемпіонату світу з футболу збірна Польщі перемогла Саудівську Аравію та вийшла на перше місце у групі C - Читайте все про ЧС-2022&nbsp;...</p></div>
            </div>
        </a><a href='https://www.ukrinform.ua/rubric-sports/3622580-cs2022-polsa-peremogla-saudivsku-araviu.html'>
            <div className={styles.card} style={{ maxWidth: "90%", width: md ? "auto": "90vh"}}>
                <h3>ЧС-2022: Польща перемогла Саудівську Аравію</h3>
                <div style={{ display: "flex" }}>
