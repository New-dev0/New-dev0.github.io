...
export default function Page() {
    ...
    return <><Head>
        <title>Гана – Уругвай</title>
        <meta name="keywords" content="news,trending,latest,sports,breaking,top,Гана – Уругвай"/>
        <meta name="description" content="Trending News about Гана – Уругвай" /></Head><Template>
            <h1 style={{fontSize: "30"}}>Гана – Уругвай</h1>
            <Image width={800} height={500} src="https://img.championat.com/news/social/1/4e/4914279.jpg" alt="Гана – Уругвай"/>
            <h3>Recent News</h3>
        ...
        </a><a href='https://www.sports.ru/football/1113890283-gana-urugvaj-02-obzor-matcha-chempionata-mira-po-futbolu-02-122022.html'>
            <div className={styles.card} style={{ maxWidth: "90%", width: md ? "auto": "90vh"}}>
            ...
            <div className={styles.card} style={{ maxWidth: "90%", width: md ? "auto": "90vh"}}>
                <h3>Гана — Уругвай</h3>
                <div style={{ display: "flex" }}>
                <Image src="https://t3.gstatic.com/images?q=tbn:ANd9GcSqxNNi4-3z6wK79hmTlrqKAFFX_r5g0v-9lWnzqOvR_PvdfyHox0-sYM5PpMXjfuDZfGi5G1oM" alt="Гана — Уругвай" height={150} width={150} style={{marginLeft: "15px"}}/>
                <p style={{marginLeft: "15px"}}>На этом будем прощаться, пожелаем сборным Уругвая и Ганы удачи и поблагодарим за игру на этом турнире. Онлайн матча для вас провел корреспондент «РБК Спорт»&nbsp;...</p></div>
            </div>
