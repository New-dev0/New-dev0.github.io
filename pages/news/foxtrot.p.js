...
export default function Page() {
    ...
    return <><Head>
        <title>Foxtrot</title>
        <meta name="keywords" content="news,trending,latest,sports,breaking,top,Foxtrot"/>
        <meta name="description" content="Trending News about Foxtrot" /></Head><Template>
            <h1 style={{fontSize: "30"}}>Foxtrot</h1>
            <Image width={800} height={500} src="https://itc.ua/wp-content/uploads/2022/11/black_fr_1920x400_2.jpg" alt="Foxtrot"/>
            <h3>Recent News</h3>
            <a href='https://itc.ua/articles/top-10-luchshyh-predlozhenyj-k-chernoj-pyatnytse-ot-fokstrota-skydky-prodlyatsya-tseluyu-nedelyu/'>
        ...
        </a><a href='https://itc.ua/ua/articles/top-10-krashhyh-propozytsij-chornoyi-p-yatnytsi-vid-fokstrot-znyzhky-tryvatymut-tsilyj-tyzhden/'>
            <div className={styles.card} style={{ maxWidth: "90%", width: md ? "auto": "90vh"}}>
