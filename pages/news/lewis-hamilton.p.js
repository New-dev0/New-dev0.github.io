...
export default function Page() {
    ...
    return <><Head>
        ...
        <meta name="description" content="Trending News about Lewis Hamilton" /></Head><Template>
            ...
            <Image width={800} height={500} src="https://www.motorsport-total.com/img/sm/274302_mst.jpg?rf=1669278581" alt="Lewis Hamilton"/>
            <h3>Recent News</h3>
            <a href='https://www.motorsport-total.com/formel-1/news/mercedes-zwischenfall-mit-sainz-nicht-schuld-an-hamiltons-ausfall-22112402'>
        ...
        </a><a href='https://www.blick.ch/sport/formel1/kann-nicht-glauben-dass-sie-nicht-mehr-da-ist-emotionaler-hamilton-trauert-um-fuenfjaehrige-isla-id18082975.html'>
            <div className={styles.card} style={{ maxWidth: "90%", width: md ? "auto": "90vh"}}>
