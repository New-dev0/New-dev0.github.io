...
export default function Page() {
    ...
    return <><Head>
        <title>映画監督死去</title>
        <meta name="keywords" content="news,trending,latest,sports,breaking,top,映画監督死去"/>
        <meta name="description" content="Trending News about 映画監督死去" /></Head><Template>
            <h1 style={{fontSize: "30"}}>映画監督死去</h1>
            <Image width={800} height={500} src="https://static.tokyo-np.co.jp/image/article/size1/0/f/8/1/0f817d8a6f1ac13d0271c9bf89abb857_1.jpg" alt="映画監督死去"/>
            <h3>Recent News</h3>
            <a href='https://www.tokyo-np.co.jp/article/216526'>
            <div className={styles.card} style={{ maxWidth: "90%", width: md ? "auto": "90vh"}}>
                <h3>崔洋一さん死去 73歳、映画監督在日コリアン描く</h3>
                <div style={{ display: "flex" }}>
                <Image src="https://t3.gstatic.com/images?q=tbn:ANd9GcQZ7FP83LPpJDG7XeWeCZsiEfC1Ig_V7HnmRc__d7nKVMWZIjYQKHvFl_aK3u7uaCQrbTwyE6bZ" alt="崔洋一さん死去 73歳、映画監督在日コリアン描く" height={150} width={150} style={{marginLeft: "15px"}}/>
                <p style={{marginLeft: "15px"}}>「月はどっちに出ている」「血と骨」など在日コリアンの物語をリアルに描いた作品で知られる映画監督で、前日本映画監督協会理事長の崔洋一（さ...</p></div>
            </div>
        </a><a href='https://www.sankei.com/article/20221127-UZ3Y4Z7AYJIHPFAEMKZPXYEUGY/'>
            <div className={styles.card} style={{ maxWidth: "90%", width: md ? "auto": "90vh"}}>
                <h3>映画監督の崔洋一さん死去 「血と骨」など</h3>
                <div style={{ display: "flex" }}>
                <Image src="https://t1.gstatic.com/images?q=tbn:ANd9GcT555o5VCADlwkTZxtykF8c_xOlPuf90kKTkBwtEeKyc2AunO4LO_TxW5phbgNVEkHgbWbRxQSI" alt="映画監督の崔洋一さん死去 「血と骨」など" height={150} width={150} style={{marginLeft: "15px"}}/>
                <p style={{marginLeft: "15px"}}>「月はどっちに出ている」「血と骨」など在日コリアンの物語をリアルに描いた作品で知られる映画監督で、前日本映画監督協会理事長の崔洋一（さい・よういち）さん&nbsp;...</p></div>
            </div>
        </a><a href='https://news.yahoo.co.jp/articles/9fe56c6e5e0828bc3e0c0e11a4dbf2b22b33fb77'>
            <div className={styles.card} style={{ maxWidth: "90%", width: md ? "auto": "90vh"}}>
            ...
            <div className={styles.card} style={{ maxWidth: "90%", width: md ? "auto": "90vh"}}>
                <h3>映画監督・崔洋一さんが死去、７３歳 「月はどっちに出ている ...</h3>
                <div style={{ display: "flex" }}>
