...
export default function Page() {
    ...
    return <><Head>
        ...
        <meta name="keywords" content="news,trending,latest,sports,breaking,top,Carlos Correa"/>
        <meta name="description" content="Trending News about Carlos Correa" /></Head><Template>
            <h1 style={{fontSize: "30"}}>Carlos Correa</h1>
            <Image width={800} height={500} src="https://www.si.com/.image/t_share/MTkzNjc0OTAwNzk4NDQ5MTM2/carlos-correa-twins.jpg" alt="Carlos Correa"/>
            <h3>Recent News</h3>
            <a href='https://www.si.com/mlb/2022/12/08/mlb-free-agency-2023-carlos-correa-destinations'>
            <div className={styles.card} style={{ maxWidth: "90%", width: md ? "auto": "90vh"}}>
                <h3>MLB Free Agency 2023: Best Destinations for SS Carlos Correa</h3>
                <div style={{ display: "flex" }}>
                <Image src="https://t3.gstatic.com/images?q=tbn:ANd9GcQ4kZnWMWuP80B2zwogSCLGJ9rz7WXnmBG_bpJG0PAJmha14XFXg-WkK3ZaC5H_V8PMC7nPeEQd" alt="MLB Free Agency 2023: Best Destinations for SS Carlos Correa" height={150} width={150} style={{marginLeft: "15px"}}/>
                <p style={{marginLeft: "15px"}}>Here are three teams that could potentially land the two-time All-Star ahead of next season.</p></div>
            </div>
        </a><a href='https://nypost.com/2022/12/08/carlos-correa-in-prime-free-agency-position-with-needy-teams/'>
            <div className={styles.card} style={{ maxWidth: "90%", width: md ? "auto": "90vh"}}>
            ...
            <div className={styles.card} style={{ maxWidth: "90%", width: md ? "auto": "90vh"}}>
                <h3>Report: New favorite to sign Carlos Correa emerges</h3>
                <div style={{ display: "flex" }}>
            ...
            <div className={styles.card} style={{ maxWidth: "90%", width: md ? "auto": "90vh"}}>
                <h3>Jon Morosi on KNBR: &#39;Very plausible scenario&#39; Giants could add ...</h3>
                <div style={{ display: "flex" }}>
