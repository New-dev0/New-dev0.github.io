...
export default function Page() {
    ...
    return <><Head>
        ...
        </a><a href='https://www.eonline.com/br/news/1355933/kris-wu-ex-membro-do-exo-e-condenado-a-13-anos-de-prisao-por-estupro'>
            <div className={styles.card} style={{ maxWidth: "90%", width: md ? "auto": "90vh"}}>
                <h3>Kris Wu, ex-membro do EXO, é condenado a 13 anos de prisão por ...</h3>
                <div style={{ display: "flex" }}>
                <Image src="https://t3.gstatic.com/images?q=tbn:ANd9GcQkcZScESwB_iB-g4KAILMOgynAwRvlfG5XsRfpfq-Kkvl0gPuGytP-YgF7IBMLV9KrrgqrhFjh" alt="Kris Wu, ex-membro do EXO, é condenado a 13 anos de prisão por ..." height={150} width={150} style={{marginLeft: "15px"}}/>
                <p style={{marginLeft: "15px"}}>A pena do ex-idol foi decidida neste 25 de novembro por um tribunal em Pequim, na China. Saiba os detalhes.</p></div>
            </div>
        </a>
        </Template></>;
}