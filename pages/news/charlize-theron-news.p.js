...
export default function Page() {
    ...
    return <><Head>
        <title>Charlize Theron news</title>
        ...
        <meta name="description" content="Trending News about Charlize Theron news" /></Head><Template>
            ...
            <div className={styles.card} style={{ maxWidth: "90%", width: md ? "auto": "90vh"}}>
                ...
                <Image src="https://t0.gstatic.com/images?q=tbn:ANd9GcTx4mgbf82mPgemac8RzJaM95m_YKwyTrnh5NdRNj7XZK_y-z0mTNe7mu2sbqhZDPLyswm7Ej4B" alt="Charlize Theron is wrong, world data shows 8.4 million people ..." height={150} width={150} style={{marginLeft: "15px"}}/>
                <p style={{marginLeft: "15px"}}>The Pan South African Language Board has rubbished comments made by Charlize Theron that Afrikaans is a dying language, spoken by 44 people.</p></div>
            </div>
        </a><a href='https://www.cnn.com/2022/11/18/entertainment/charlize-theron-afrikaans-backlash-south-africa-intl-scli/index.html'>
            <div className={styles.card} style={{ maxWidth: "90%", width: md ? "auto": "90vh"}}>
                <h3>Charlize Theron faces backlash after saying Afrikaans, her mother ...</h3>
                <div style={{ display: "flex" }}>
