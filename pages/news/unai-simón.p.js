...
export default function Page() {
    ...
    return <><Head>
        <title>Unai simón</title>
        <meta name="keywords" content="news,trending,latest,sports,breaking,top,Unai simón"/>
        <meta name="description" content="Trending News about Unai simón" /></Head><Template>
            <h1 style={{fontSize: "30"}}>Unai simón</h1>
            <Image width={800} height={500} src="https://imagens.ne10.uol.com.br/veiculos/_midias/jpg/2022/11/27/615x300/1_unai_simon-22087097.jpg" alt="Unai simón"/>
            <h3>Recent News</h3>
