...
export default function Page() {
    ...
    return <><Head>
        ...
        <meta name="description" content="Trending News about Gert Steinbäcker" /></Head><Template>
            ...
            <Image width={800} height={500} src="https://image.kurier.at/images/facebook/7431879/46-192049980.jpg" alt="Gert Steinbäcker"/>
            <h3>Recent News</h3>
            <a href='https://kurier.at/kultur/gert-steinbaecker-beruehmt-werden-muss-ich-nicht-mehr/402237621'>
        ...
        </a><a href='https://www.meinbezirk.at/murtal/c-leute/die-legende-gert-steinbaecker-startete-ihre-letzte-tour_a5710054'>
            <div className={styles.card} style={{ maxWidth: "90%", width: md ? "auto": "90vh"}}>
