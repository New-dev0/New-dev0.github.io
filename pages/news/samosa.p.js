    ...
    return <><Head>
        ...
        <meta name="description" content="Trending News about Samosa" /></Head><Template>
            ...
            <div className={styles.card} style={{ maxWidth: "90%", width: md ? "auto": "90vh"}}>
                ...
                <Image src="https://t3.gstatic.com/images?q=tbn:ANd9GcSKn8gRQrCgO1rXq9oM5DBVKrf__RYOeDHkboHit0LoimsAtsWNqHvnjvfYvoGaQp-Zt2QiMJNA" alt="Samosa Interesting Facts: बेहद दिलचस्प है समोसे का इतिहास, क्या आप ..." height={150} width={150} style={{marginLeft: "15px"}}/>
