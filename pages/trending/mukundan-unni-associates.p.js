...
export default function Page() {
    ...
    return <><Head>
        ...
        </a><a href='https://www.cinemaexpress.com/malayalam/review/2022/nov/11/mukundan-unni-associates-review-vineeth-sreenivasan-36528.html'>
            <div className={styles.card} style={{ maxWidth: "90%", width: md ? "auto": "90vh"}}>
                <h3>Mukundan Unni Associates Review: Vineeth Sreenivasan aces it as ...</h3>
                <div style={{ display: "flex" }}>
                <Image src="https://t2.gstatic.com/images?q=tbn:ANd9GcTf7V8sSQrZka3Z-iwKL4GnKXs0ROcurp_e9hKgrkS_B8PfYjDfadcybTSPfB-7eHjNVa5hf8v3" alt="Mukundan Unni Associates Review: Vineeth Sreenivasan aces it as ..." height={150} width={150} style={{marginLeft: "15px"}}/>
                <p style={{marginLeft: "15px"}}>Mukundan Unni Associates is also the most visually inventive film since Thallumaala. It puts as much thought into the presentation as it does the&nbsp;...</p></div>
            </div>
