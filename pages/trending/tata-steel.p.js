...
export default function Page() {
    ...
    return <><Head>
        <title>Tata Steel</title></Head><Template>
            ...
            <h3>Recent News</h3>
            <a href='https://www.livemint.com/companies/news/tata-steel-set-to-merge-seven-subsidiaries-in-synergy-drive-11663953048688.html'>
            <div className={styles.card} style={{ maxWidth: "90%", width: md ? "auto": "90vh"}}>
                <h3>Tata Steel set to merge seven subsidiaries in synergy drive | Mint</h3>
            ...
            <div className={styles.card} style={{ maxWidth: "90%", width: md ? "auto": "90vh"}}>
                <h3>Tata Steel to merge 7 subsidiaries with itself</h3>
                <div style={{ display: "flex" }}>
            ...
            <div className={styles.card} style={{ maxWidth: "90%", width: md ? "auto": "90vh"}}>
                <h3>tata steel: Tata Steel to merge seven group companies with self ...</h3>
                <div style={{ display: "flex" }}>
                <Image src="https://t0.gstatic.com/images?q=tbn:ANd9GcR1z6HprhBKVW-l-wU6AlrMRpwQKj-h_RCRiKk7QjR2rTmWI_OVejldZshcRCLH0IbXamgmRZWg" alt="tata steel: Tata Steel to merge seven group companies with self ..." height={150} width={150} style={{marginLeft: "15px"}}/>
                <p style={{marginLeft: "15px"}}>Four of these companies - Tata Steel Long Products, Tinplate Company, Tata Metaliks and TRF - are listed. Their stocks declined after the merger&nbsp;...</p></div>
            </div>
        </a><a href='https://lagatar24.com/tata-steels-board-approves-amalgamation-of-six-subsidiary-units/122493/'>
            <div className={styles.card} style={{ maxWidth: "90%", width: md ? "auto": "90vh"}}>
                <h3>Tata Steel&#39;s board approves amalgamation of six subsidiary units ...</h3>
                <div style={{ display: "flex" }}>
            ...
            <div className={styles.card} style={{ maxWidth: "90%", width: md ? "auto": "90vh"}}>
                <h3>Tata Steel के सीएफओ Koushik Chatterjee ने बताई मेटल कंपनियों के ...</h3>
                <div style={{ display: "flex" }}>
            ...
            <div className={styles.card} style={{ maxWidth: "90%", width: md ? "auto": "90vh"}}>
                <h3>Tata Steel Merger: टाटा ग्रुप की सभी मेटल कंपनियों का टाटा स्टील में होगा ...</h3>
                <div style={{ display: "flex" }}>
                <Image src="https://t3.gstatic.com/images?q=tbn:ANd9GcTp0Kzwh-8Q2gSTXQq8fQL5DstFjUpiYp1lgNVcOJsQ2uXpXbQ0rH4u_eZWHz8O65NQPIir_1Zw" alt="Tata Steel Merger: टाटा ग्रुप की सभी मेटल कंपनियों का टाटा स्टील में होगा ..." height={150} width={150} style={{marginLeft: "15px"}}/>
                <p style={{marginLeft: "15px"}}>Tata Steel Merger: टाटा स्टील के बोर्ड ऑफ डायरेक्टर्स ने छह सहायक कंपनियों के टाटा स्टील में&nbsp;...</p></div>
            </div>
        </a>
        </Template></>;
}